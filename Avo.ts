// Generated by Avo VERSION 96.17.0. You should never have to make changes to this file.
...
let Mixpanel = {
  ...
  addCurrentUserToGroup: function addCurrentUserToGroup(groupTypeName: string, groupId: string) {
    if (typeof (window as any) === 'undefined') { return; }
    (this as any).getInstance().set_group(groupTypeName, groupId);
  },
  ...
  logEventWithGroups: function logEventWithGroups(eventName: string, eventProperties: {[name: string] : any}, groupTypeNamesToGroupIds: object) {
    if (typeof window === 'undefined') { return; }
    (this as any).getInstance().track_with_groups(eventName, eventProperties, groupTypeNamesToGroupIds);
  },
  ...
  setGroupProperties: function setGroupProperties(groupTypeName: string, groupType: string, groupProperties: object) {
    if (typeof window === 'undefined') { return; }
    (this as any).getInstance().get_group(groupTypeName, groupType).set(groupProperties);
  },
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/35_wLFqR0}
 */
export function feedbackGiven(properties: FeedbackGivenProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "35_wLFqR0", "5e4033bd4f57356defd63a2c91d84c2f37cf705fcee6cd91f5a8a81f3cd6dd96", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/0FvnJgpVbz}
 */
export function contentCopied(properties: ContentCopiedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "0FvnJgpVbz", "a1957ef9b84b8f29012e1e9f97ff61250039ea456028ff892b1392f196baee65", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
 ...
 * @param properties.path: pathname from the URL, e.g. 'https://www.avo.app/docs/quickstart/' -> 'docs/quickstart'
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/J4cW6PmriY}
 */
export function docsPageViewed(properties: DocsPageViewedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "J4cW6PmriY", "417dede293053169a1c89e095789e3dfbbc2f7bfe48d4f9f5e0f5691d021a599", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/FWqOBDDhHU}
 */
export function docsSearchInitialized() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "FWqOBDDhHU", "7c779d7bf63cd360c54ff24d3ceb1f66e4d670d433679ac2088af29db41fa600", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/YartShpgKH}
 */
export function docsSearchResultSelected(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "YartShpgKH", "6df6ade9a8681938b55b334c4f29ab1b88bbc5d15e5915a0c4192b55d2f627fb", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
 ...
 * @param properties.searchResultCount: The total number of search results available when the event was sent.
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/VDuVWCzr4/events/OPFGpaxOEx}
 */
export function docsSearchAbandoned(properties: DocsSearchAbandonedProperties
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "OPFGpaxOEx", "e4680184c4dc2aac03cea74ad05402370a8e10017979038f1bd22705df6e70d1", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
